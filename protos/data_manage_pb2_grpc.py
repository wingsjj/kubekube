...
class ManagerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddTaskLog = channel.unary_unary(
                '/Manager/AddTaskLog',
                request_serializer=protos_dot_data__manage__pb2.TaskLog.SerializeToString,
                response_deserializer=protos_dot_data__manage__pb2.Reply.FromString,
                )
...
def add_ManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AddTaskLog': grpc.unary_unary_rpc_method_handler(
                    servicer.AddTaskLog,
                    request_deserializer=protos_dot_data__manage__pb2.TaskLog.FromString,
                    response_serializer=protos_dot_data__manage__pb2.Reply.SerializeToString,
            ),
    }
...
class Manager(object):
    ...
    def AddTaskLog(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Manager/AddTaskLog',
            protos_dot_data__manage__pb2.TaskLog.SerializeToString,
            protos_dot_data__manage__pb2.Reply.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
